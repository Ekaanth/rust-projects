...
use ethers::prelude::{
    BlockNumber, ContractFactory, LocalWallet, Signer, SignerMiddleware, U256,
};
use ethers::utils::Ganache;
use ethers_providers::{Middleware, Provider};
use ethers_solc::info::ContractInfo;
use ethers_solc::{Artifact, ProjectCompileOutput, ConfigurableArtifacts, ProjectPathsConfig, Project};
use eyre::Result;
...
async fn main() -> Result<()> {
    ...
    let contract = project.find_contract(ContractInfo::new("examples/BUSDImplementation.sol:BUSDImplementation"))
